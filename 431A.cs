...
namespace Issue_431A
{
    public static class Program
    {
        public static void Main(string[] args) {
			...
			var calories = new int[lines_count];
			for (var i = 0; i < lines_count; ++i) {
				calories[i] = IO.Read();
			}

			var game_process = IO.ReadLine();
			var wasted = 0;
			for (var i = 0; i < game_process.Length; ++i) {
				var index = (int) game_process[i] - (int) '1';
				wasted += calories[index];
			}
