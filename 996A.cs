...
namespace Issue
{
    public static class Program
    {
        public static void Main(string[] args) {
			...
			var thundreds = money / 100;
			var after_thundreds = money % 100;

			var twentys = after_thundreds / 20;
			var after_twentys = after_thundreds % 20;

			var tens = after_twentys / 10;
			var after_tens = after_twentys % 10;

			var fifths = after_tens / 5;
			var after_fifths = after_tens % 5;

			var ones = after_fifths;

			var result = thundreds + twentys + tens + fifths + ones;
