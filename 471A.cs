...
namespace Issue_471A
{
    class Program
    {
        ...
        private static bool IsBear(int[] sticks) {
                    // legs                    // head      // body
            return (sticks[0] == sticks[3] && sticks[4] < sticks[5])
                || (sticks[1] == sticks[4] && sticks[0] < sticks[5])
                || (sticks[2] == sticks[5] && sticks[0] < sticks[1]);
        }
