...
namespace Issue
{
    public static class Program
    {
        public static void Main(string[] args) {
			var participans_count = IO.Read();
			var pens_count = IO.Read();
			var notebooks_count = IO.Read();

			var isEnough = pens_count >= participans_count 
				&& notebooks_count >= participans_count;

			Console.WriteLine(isEnough ? "YES" : "NO");
        }
    }
